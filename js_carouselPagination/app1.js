class Carousel {
    ...
    constructor (element, options = {}) {
        ...
        this.setStyle()
        // condition si on a la navigation
        if (this.options.navigation) {
            this.createNavigation()
        }

        // condition si on a la pagination
    ...
    createPagination () {
        ...
        // création des boutons en fonction du nbre d'images
        for (let i = 0; i < this.items.length; i = i + this.options.slidesToScroll){
            let button = this.createDivWithClass('carousel-pagination-button')
            // création de l'événement lors du click d'aller a l'element choissit
